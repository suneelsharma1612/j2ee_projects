...
<%
    ...
    String rec="select * from tbl_billingadd where userEmail='"+session.getAttribute("uid")+"'";
    ResultSet rs1=db1.getRecord(rec);
    if(rs1.next())
    {
        out.print("<script>alert('Already Added The Billing Address');window.location.href='index.jsp';</script>");
    }
%>
...
<head>
    <title>ShoozApp | Billing Add</title>
...
<div class="login">
    ...
    <div class="main-agileits">
        <div class="form-w3agile">
            <h3>Add Billing Add</h3>
            <form action="userzone/billingaddcode.jsp" method="post">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        ...
                        <select required="" class="selectbox" name="country" style="height: 45px;color: #999;">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        ...
                        <select required="" class="selectbox" name="state" style="height: 45px;color: #999;">
